...
<head>
    <title>Winding Machines| KPS Machinery</title>
...
<body onload="createCaptcha();">
    <div class="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-4" data-aos="zoom-in-up">
                        <div class="leftBannerBottom">
                            ...
                            <h4 class="heading fontWeight700 fontHeading">Winding Machines </h4>
        ...
        <!-- machinery sepecial -->
        <section class="machinery winding-machines">
            <div class="containerFull">
                <div class="row ">
                    <div class="col-lg-6 machinery_inner_left">
                        <div class="machinery_inner_left_inner">
                            ...
                            <ul class="">
                                <li>Solid frame welded construction</li>
                                <li>Single or Multiple Wires</li>
                                <li>Single or Multiple Coils</li>
                                <li>Wire tension control. <br>
                                    <p>-Pneumatic Brakes</p>
                                    <p>-Servo motor controlled</p>
                                </li>

                                <li>Servo motor controlled Mandrel and Traverse</li>
                                <li>Machine Control software build on Industrial computer with Windows platform</li>
                                <li>Remote updates and troubleshooting through internet</li>
                                <li>Programmable Operator instructions from the main frame or through USB</li>
