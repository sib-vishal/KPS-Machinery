...
<body onload="createCaptcha();">
    <div class="wrapper">
                    ...
                    <div class="col-lg-6 machinery_inner_right ">
                        <div class="machinery_inner_right_inner shadow rounded-2">
                            ...
                            <video class="myVideo" loop="" muted="" playsinline=""
                                poster="images/products/kps-ctl-250/kps-machinery-core-cutting-machines-video-1.jpg">
                                <source src="images/products/kps-ctl-250/core-cutting-machines-video.mp4"
                                    type="video/mp4">
                            </video>
                        </div>
        ...
        <!-- machinery sepecial 2-->
        <section class="machinery  section2" style="background:#f6f6f6">
            <div class="containerFull">
                <div class="row ">
                    <div class="col-lg-6 machinery_inner_right ">
                        <div class="machinery_inner_right_inner shadow rounded-2">
                            ...
                            <video class="myVideo" loop="" muted="" playsinline=""
                                poster="images/products/kps-ctl-300/kps-machinery-core-cutting-machines-video-6.jpg">
                                <source src="images/products/kps-ctl-300/core-cutting-machines-video-6.mp4"
                                    type="video/mp4">
                            </video>
                        </div>
                    ...
                    <div class="col-lg-6 machinery_inner_left">
                        <div class="machinery_inner_left_inner w-100">
                            <p class="small_heading fontWeight600 fontHeading  mt-3 text_primary">
                                Standard machines
                            </p>
                            <h3 class="text_secondary mt-2 pb-4 heading fontWeight700 fontHeading"> <span></span>
                ...
                <div class="row ">
                    <div class="col-lg-6 machinery_inner_left">
                        <div class="machinery_inner_left_inner ">
                            ...
                            <p>Swing-shear cutting line, with notch moving IN and OUT, fixed Punch, suitable for
                                distribution transformer cores (Step Lap Mitre or Butt-lap), ranging from 100 mm width
                            ...
                            <ul>
                                <li> Two Headed Decoiler, with hydraulic expand-and-collapse function</li>

                                <li> *Optional 4 headed decoiler, or as-specified</li>
                                ...
                                <li> Servo controlled tool fire for two punches, V-Notch, and Swing Shear</li>
                    ...
                    <div class="col-lg-6 machinery_inner_right ">
                        <div class="machinery_inner_right_inner shadow rounded-2">
                            ...
                            <video class="myVideo" loop="" muted="" playsinline=""
                                poster="images/products/kps-ctl-600/kps-machinery-core-cutting-machines-video-7.jpg">
                                <source src="images/products/kps-ctl-600/core-cutting-machines-video-7.mp4"
                                    type="video/mp4">
                            </video>
                        </div>
                    </div>
        ...
        <section class="products-gallery" style="background:#f6f6f6">
            <div class="containerFull">
                ...
                <p class="small_heading fontWeight600 fontHeading  mt-3 text_primary">KPS Machinery | Core cutting
                    machines</p>
                <h4 class="text_secondary mt-2 pb-4 heading fontWeight700 fontHeading">
                    Videos & Galleries
                </h4>
                <div class="products-gallery-grid">
                    <a href="images/products/kps-ctl-250/core-cutting-machines-video.mp4" rel="gallery"
                        data-caption="KPS CTL 250" data-fancybox="Gallery" class="grid-item shadow">
                    ...
                    <a href="images/products/kps-ctl-300/core-cutting-machines-video-6.mp4" rel="gallery"
                        data-caption="KPS CTL 300" data-fancybox="Gallery" class="grid-item shadow">
                        <img class="object-fit-cover w-100"
